# Generated by Django 3.1 on 2022-04-18 15:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_tester_type', models.SmallIntegerField(choices=[(0, 'PC'), (1, 'wap'), (2, 'applet')], default=0, verbose_name='平台')),
        ...
        migrations.CreateModel(
            name='TestInterface',
            fields=[
                ('interfaceid', models.CharField(max_length=64, primary_key=True, serialize=False, unique=True, verbose_name='接口编号')),
                ('interfaceurl', models.CharField(max_length=64, unique=True, verbose_name='接口地址')),
                ('interfacetype', models.CharField(max_length=64, verbose_name='请求类型')),
                ('paramtype', models.SmallIntegerField(choices=[(0, 'Json'), (1, 'Text')], default=0, verbose_name='参数类型')),
                ('testdata', models.CharField(max_length=64, verbose_name='测试数据')),
