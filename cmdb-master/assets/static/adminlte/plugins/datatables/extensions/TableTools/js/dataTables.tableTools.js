...
TableTools.prototype = {
	...
	/**
	 * Get the data source objects/arrays.txt from DataTables for the selected rows (same as
	...
	/**
	 * Take the user input arrays.txt and expand them to be fully defined, and then add them to a given
	 * DOM element
